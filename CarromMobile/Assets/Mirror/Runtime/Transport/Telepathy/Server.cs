...
namespace Telepathy
{
    ...
    {
        public int counter;
        public Queue<int> connIds=new Queue<int>();
       ...
       /* public int NextConnectionId()
        ...
        public void Stop()
        {
            ...
            counter = 0;
            Logger.Log("Counter in stop" + counter);
            connIds.Clear();
        }
        ...
        public void AlterConnIdWhen2PClientDisconnects(int connectionId)
        {
        ...
        public void AlterConnIdWhen4PClientDisconnects(int connectionId)
        {
            Logger.Log("counter----------" + counter);
            if (counter == 3)
            {
                connIds.Enqueue(connectionId);
            }
            else if(counter>0)
                counter--;
            Logger.Log("Counter" + counter);
